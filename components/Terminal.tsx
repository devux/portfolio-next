...
const Terminal = () => {
  ...
  const codeLines: CodeLines = useMemo(() => ({
    python: [
      'print("Hello, World! 👋 I\'m Karthiga")',
      'print("Based in India 🍁 IN")',
      'print("From Data to Code: Software Developer with 8+ years in Python, JavaScript, and Data Analytics, specializing in Web Development and Automation")'
    ],
    javascript: [
      'console.log("Hello, World! 👋 I\'m Karthiga");',
      'console.log("Based in India 🍁 IN");',
      'console.log("From Data to Code: Software Developer with 8+ years in JavaScript, and Data Analytics, specializing in Web Development and Automation");'
    ]
  }), []);
    ...
    >
      ...
      >
        ...
        >
          ...
          <span className="text-primary">karthiga@portfolio:~$</span>
